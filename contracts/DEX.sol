...
contract DEX is Ownable {
    ...
    function addLiquidityETH(
        ...
        if (keccak256(abi.encodePacked(tokenAddressToName[_token])) == keccak256(abi.encodePacked(""))) {
            ...
            liquidityProviderToLiquidityProvided[msg.sender][_token] = liquidityProviderToLiquidityProvided[msg.sender][
                _token
            ].add(deltaToken);
            liquidityProviderToLiquidityProvided[msg.sender][WETH] = liquidityProviderToLiquidityProvided[msg.sender][
                WETH
            ].add(msg.value);
    ...
    function removeLiquidityETH(
        ...
        liquidityProviderToLiquidityProvided[msg.sender][WETH] = liquidityProviderToLiquidityProvided[msg.sender][WETH]
            .sub(_ethAmount);
        liquidityProviderToLiquidityProvided[msg.sender][_token] = liquidityProviderToLiquidityProvided[msg.sender][
            _token
        ].sub(_tokenAmount);
